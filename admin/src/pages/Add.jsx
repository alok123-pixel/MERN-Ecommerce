...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-3'>
      ...
      {/* pink border effect is written in index.css file */}
      <div className='w-full'>
        <p>Product description</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='write something about your product' required />
      </div>
