...
function Placeorder() {
  ...
  const{navigate,backendUrl,token,setCartItems,cartItmes, delivery_fee,products,getCarAmount} = useContext(ShopContext);
    ...
    <form onSubmit={onsubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
       ...
       <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
         <div className='text-xl sm:text-2xl my-3'>
          ...
          <input required onChange={onChangeHandler} name='email' value={formData.email} className='border border-gray-300 py-1.5 px-3.5 w-full' type='email' placeholder='Enter email ' />
          <input required onChange={onChangeHandler} name='street' value={formData.street} className='border border-gray-300 py-1.5 px-3.5 w-full' type='text' placeholder='Street name ' />
          <div className='flex gap-3'> 
          ...
          <div className='flex gap-3'> 
             <input required onChange={onChangeHandler} name='zipcode' value={formData.zipcode} className='border border-gray-300 py-1.5 px-3.5 w-full' type='number' placeholder='Zipcode' />
